package com.ohigraffers.section01.problem;
...
public class ProblemsOfUsingDirectSqlTest {
    ...
    * */
    ...
    void testDirectSelectSql() throws SQLException {
        ...
        while(rs.next()){
            Menu menu = new Menu(rs.getInt("MENU_CODE"), rs.getString("MENU_NAME")
            ,rs.getInt("MENU_PRICE"), rs.getInt("CATEGORY_CODE")
    ...
    void testDirectInsertSQL() throws SQLException {
        ...
        pstmt.setInt(3, menu.getCateogryCode());
    ...
    * */
     ...
     *   슈퍼타이브이 모든 속성을 서브 타입이 공유하지 못하여 물리적으로 다른 테이블로 분리가 된 형태이다.
