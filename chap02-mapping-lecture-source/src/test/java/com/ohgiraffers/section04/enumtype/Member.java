...
public class Member {
    ...
    public Member(int memberNo, String memberId, String memberPwd, String nickname, String phon, String email, String address, Date enrollDate, RoleType memberRole, String status) {
