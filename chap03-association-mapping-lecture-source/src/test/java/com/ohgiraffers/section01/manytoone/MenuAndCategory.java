...
public class MenuAndCategory {
    ...
    /* 설명.
     *  FetchType.LAZY(지연로딩)와 FetchType.EAGER(즉시로딩)
    ...
    * */
    ...
    private Category cateogry;          // 메뉴 1개가 카테고리 엔티티 객체 몇개를 가지는지(List<타입>/타입)
    ...
    public MenuAndCategory(int menuCode, String menuName, int menuPrice, Category cateogry, String orderableStatus) {
